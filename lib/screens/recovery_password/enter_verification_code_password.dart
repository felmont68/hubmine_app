...
import 'package:mining_solutions/screens/recovery_password/create_new_password.dart';
...
class RecoveryCodePassword extends StatefulWidget {
  // ignore: use_key_in_widget_constructors
  final String email;
  const RecoveryCodePassword({
    Key? key,
    required this.email,
  }) : super(key: key);

  @override
  _RecoveryCodePasswordState createState() => _RecoveryCodePasswordState();
}

class _RecoveryCodePasswordState extends State<RecoveryCodePassword> {
                ...
                children: [
                  ...
                  PinCodeTextField(
                    ...
                    onCompleted: (value) async {
                      ...
                      if (await verificateCodeToRecoveryPassword(
                          value, context)) {
                    ...
                    children: [
                      ...
                      TimerCountDownWidget(
                          ...
                          onTimerFinish: () async {
                            ...
                            if (await sendCodeToRecoveryPassword(
                                widget.email)) {
                              setState(() {
                                newCodeSend = true;
                                clearTextInput();
