...
import 'package:mining_solutions/screens/register/registers_page.dart';
...
class EnterCodeRegisterWithPhone extends StatefulWidget {
  const EnterCodeRegisterWithPhone({
    Key? key,
  });

  @override
  _EnterCodeRegisterWithPhoneState createState() =>
      _EnterCodeRegisterWithPhoneState();
}

class _EnterCodeRegisterWithPhoneState
    extends State<EnterCodeRegisterWithPhone> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // ),
                  Text(
                    AppLocalizations.of(context).enterVerificationCodeTitle,
                    style: heading,
                  ),
                  ...
                  PinCodeTextField(
                    ...
                    textStyle: const TextStyle(color: textBlack),
                    length: 5,
                    obscureText: false,
                    ...
                    onCompleted: (value) async {
                      ...
                      if (await verificateOTPToCreateAccount(
                          value, phoneOTP.phone, context)) {
                    ...
                    children: [
                      ...
                      TimerCountDownWidget(
                          ...
                          onTimerFinish: () async {
                            ...
                            if (await sendOtpRegister(phoneOTP.phone)) {
                              setState(() {
                                newCodeSend = true;
                                clearTextInput();
                              });
