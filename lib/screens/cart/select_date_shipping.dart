...
class SelectDateShippingPage extends StatefulWidget {
  const SelectDateShippingPage({Key? key}) : super(key: key);

  @override
  State<SelectDateShippingPage> createState() => _SelectDateShippingPageState();
}

class _SelectDateShippingPageState extends State<SelectDateShippingPage> {
  List dates = [];
  ...
  loadDatesAvailable(date) async {
    ...
    var _url = Uri.parse(
        "http://23.100.25.47:8010/api/cart/hour-available?date=$formatted");
                ...
                ElevatedButton(
                    ...
                    onPressed: () {
                      if (dateTaped != null) {
                        ...
                        userInfo.timeShipping = dates[dateTaped!]['hour'];
